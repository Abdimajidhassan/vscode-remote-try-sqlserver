...
-- Custom Query Example: Department Performance Report
SELECT 
    c.AdvisorDepartment,
    ...
    AVG(CASE 
        ...
        WHEN e.Grade = 'F' THEN 0.0
        ELSE NULL
    END) AS AverageDepartmentGPA
FROM 
    Departments c
    JOIN Enrollments e ON c.DepartmentID = e.DeartmentID
    JOIN Students s ON e.StudentID = s.StudentID
GROUP BY 
    c.Department
ORDER BY 
    AverageDepartmentGPA DESC;
GO